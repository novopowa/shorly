function Privacy() {
	return (
		<div className='[&>p]:mb-3 [&>h2]:mt-6 [&>h2]:mb-3 [&>h2]:text-3xl [&>h3]:mb-3 [&>ul>li]:mb-3 [&>h3]:text-xl [&>ul]:mb-3 mx-auto max-w-2xl px-3 pb-10'>
			...
			<ul>
				...
				<li>
					<p>
						<strong>Application</strong> refers to Shorly, the software program provided by the Company.
					</p>
				</li>
				<li>
					<p>
						<strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
						&quot;Our&quot; in this Agreement) refers to Shorly.
					</p>
				</li>
				<li>
					<p>
			...
			<p>
				...
				Media Service&apos;s account. If You choose to provide such information and Personal Data, during registration
				or otherwise, You are giving the Company permission to use, share, and store it in a manner consistent with this
				Privacy Policy.
			</p>
			...
			<ul>
				<li>By email: aleix1989@gmail.com</li>
			</ul>
		</div>
	)
}
